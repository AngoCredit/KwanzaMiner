    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/75 backdrop-blur-sm animate-in fade-in duration-200 overflow-y-auto">
      <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl border border-slate-200 overflow-hidden relative my-6">
        ...
        <div className="p-6 max-h-[80vh] overflow-y-auto">
          ...
          {/* Real Google OAuth Action Button */}
          <div className="space-y-3">
            <button
              ...
              disabled={isLoading}
              className="w-full py-2.5 px-4 rounded-xl border-2 border-slate-200 hover:border-[#4285F4]/40 bg-white hover:bg-blue-50/30 text-slate-700 text-sm font-bold shadow-xs transition-all flex items-center justify-center gap-3"
            >
              ...
              <span>
                {authMode === 'login' ? 'Continuar com a Conta Google' : 'Cadastrar com o Google'}
              </span>
            </button>
